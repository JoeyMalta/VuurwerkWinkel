            ...
            <div class="collapse navbar-collapse" id="navcol-1">
                <ul class="nav navbar-nav navbar-right">
                    ...
                    <li class="dropdown"><a class="dropdown-toggle" data-toggle="dropdown" aria-expanded="false" href="#"><i class="glyphicon glyphicon-th-list"></i>&nbsp;Vuurwerk Merk<span class="caret"></span></a>
                        <ul class="dropdown-menu" role="menu">
                            <li role="presentation"><a href="index.php">PottenMakers</a></li>
                            <li role="presentation"><a href="#">SierPlezier</a></li>
                            <li role="presentation"><a href="#">PottenPiraten</a></li>
                        </ul>
                    </li>
                </ul>
            </div>
