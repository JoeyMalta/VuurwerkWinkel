                ...
                <ul class="nav navbar-nav navbar-right">
                    <li class="dropdown"><a class="dropdown-toggle" data-toggle="dropdown" aria-expanded="false" href="#"><i class="glyphicon glyphicon-search"></i>&nbsp;Vuurwerk Catagorie&nbsp;<span class="caret"></span></a>
                        <ul class="dropdown-menu" role="menu">
                            <li role="presentation"><a href="KnalVuurwerk.php">KnalVuurwerk</a></li>
                            <li role="presentation"><a href="SierVuurwerk.php">SierVuurwerk</a></li>
                            <li role="presentation"><a href="index.php">Hoofd Pagina</a></li>
                        </ul>
                    </li>
                    <li class="dropdown"><a class="dropdown-toggle" data-toggle="dropdown" aria-expanded="false" href="#"><i class="glyphicon glyphicon-th-list"></i>&nbsp;Vuurwerk Merk<span class="caret"></span></a>
                        <ul class="dropdown-menu" role="menu">
                            <li role="presentation"><a href="index.php">PetKnallers</a></li>
                            <li role="presentation"><a href="#">KinderHaakjes</a></li>
                            <li role="presentation"><a href="#">SpetterKnallers</a></li>
                        </ul>
                    </li>
                </ul>
            </div>
        ...
        <div class="container">
            <div class="row">
                <div class="col-md-4 col-sm-6 footer-navigation">
                    ...
                    <p class="links"><a href="#">Shaif</a><strong> ·</strong></p>
