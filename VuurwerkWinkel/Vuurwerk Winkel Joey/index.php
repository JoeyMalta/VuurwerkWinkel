...
<body>
        ...
        <div class="container">
            ...
            <div
                ...
                <ul class="nav navbar-nav navbar-right">
                    <li class="active" role="presentation"><a href="#">Kerst Korting!</a></li>
                    <li role="presentation"><a href="#">Onze Folder</a></li>
                    <li role="presentation"><a href="#">Inloggen</a></li>
                    <li role="presentation"><a href="#">Aanmelden</a></li>
                </ul>
        </div>
        </div>
    </nav>
    <div id="promo" style="background-image: url(&quot;assets/img/background.jpg.jpg&quot;);">
        <div class="jumbotron">
            ...
            <p><a class="btn btn-info btn-lg" role="button" href="#">Nu 20% Korting!</a></p>
        </div>
    </div>
