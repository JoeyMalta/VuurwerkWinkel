...
<body>
    <nav class="navbar navbar-inverse navbar-fixed-top">
        <div class="container">
            <div class="navbar-header"><a class="navbar-brand" href="index.php" data-aos="slide-up" data-aos-duration="3000"><img src="firework03.png" data-aos="fade-up-right" data-aos-duration="2500" id="logo"><strong>FireworkWizards</strong></a><button class="navbar-toggle collapsed"
    ...
    <div id="promo" style="background-image: url(&quot;background.jpg&quot;);">
        <div class="jumbotron">
    ...
    <div class="container site-section" id="welcome">
        <h1>FireworkWizards website Bartek</h1>
        <p>Dit is een Opdracht website van Bartek </p>
    </div>
        ...
        <div class="container site-section" id="why">
            ...
            <div class="row">
                <div class="col-md-4 item"><i class="glyphicon glyphicon-leaf"></i>
                    <h2>Vuurwerk met beste kwaliteiten</h2>
            ...
            <div class="col-md-4">
                <a href=<?= '"'. $row["Afbeelding"] . '"' ?> target="_blank" data-lightbox="cakes"><img class="img-responsive" src=<?= '"'. $row["Afbeelding"] . '"' ?> data-bs-hover-animate="pulse"></a>
                    ...
                    <?php } }?>
						...
						<h2>Onze compleet assortiment</h2>
        <div class="row">
		<div class="column">
            <?php
            $sql = "SELECT Afbeelding, Prijs, Artikelnaam FROM vuurpijlen";
            $result = $dbcon->query($sql);
            if ($result->num_rows > 0) {
    // output data of each row
    while($row = $result->fetch_assoc()) {
            ...
            <div class="col-md-4">
                <a href=<?= '"'. $row["Afbeelding"] . '"' ?> target="_blank" data-lightbox="cakes"><img class="img-responsive" src=<?= '"'. $row["Afbeelding"] . '"' ?> data-bs-hover-animate="pulse"></a>
                    ...
                    <?php } }?>
						...
						<h3>Onze  knalvuurwerk</h3>
        <div class="row">
		<div class="column">
            <?php
            $sql = "SELECT Afbeelding, Prijs, Artikelnaam FROM knalvuurwerk";
            $result = $dbcon->query($sql);
            if ($result->num_rows > 0) {
    // output data of each row
    while($row = $result->fetch_assoc()) {
        ...
        <div class="container">
            <div class="row">
                <div class="col-md-4 col-sm-6 footer-navigation">
                    ...
                    <p class="links">Bartek<strong> </strong></p>
                    <p class="company-name">FireworkWizards © 2018</p>
                </div>
                <div class="col-md-4 col-sm-6 footer-contacts">
                    <div><span class="fa fa-map-marker footer-contacts-icon"> </span>
                        <p><span class="new-line-span">Madeliefstraat 33B</span> Rotterdam, Zuidholland</p>
                    </div>
